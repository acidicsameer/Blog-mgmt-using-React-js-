  ...
  <div className="max-w-[556px] px-4 py-10 mx-auto  flex flex-col ">
      ...
      <div className="w-full flex flex-col justify-start items-start gap-6">
        ...
        <div className="w-full">
          ...
          <label className=" dark:text-white text-black text-base font-normal  leading-7">Title</label><input placeholder="title" type="text" className="mt-2 w-full px-5 py-2 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-black  overflow-hidden  text-[#898989] text-lg font-normal "  required />
        </div>
         <div className="w-full">
        ...
        <div className="w-full">
          <label className="dark:text-white text-black text-base font-normal  leading-7">subtitle</label><input placeholder="subtitle" type=" text" className="mt-2 w-full px-5 py-2 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-black  overflow-hidden  text-[#898989] text-lg font-normal "  required />
        </div>
        <div className="w-full">
